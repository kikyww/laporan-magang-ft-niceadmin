        ...
        <div class="card-body">
          ...
          <form action="submit_nilai.php" method="POST">
            <div class="row mb-3" hidden>
              <div class="col-sm-10">
                <input name="usn" type="text" class="form-control" value="<?= $username ?>" readonly>
              </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="d-flex justify-content-end mt-3">
              ...
              <a href="data_nilai.php" class="btn btn-warning" style="margin-left:6px; margin-right:6px">Kembali</a>
