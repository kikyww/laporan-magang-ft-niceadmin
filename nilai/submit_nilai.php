...
if ($_SESSION['status'] != "admin") {
    ...
    $sql = "INSERT INTO tb_nilai (id_nilai, usn_nilai, n_sopan, n_disiplin, n_keaktifan, n_sungguh, n_mandiri, n_bersama, n_teliti, n_pendapat, n_menyerap, n_kreatif, rata_rata) VALUES ('$id', '$usn', '$sopan', '$disiplin', '$aktif', '$sungguh', '$mandiri', '$bersama', '$teliti', '$pendapat', '$menyerap', '$kreatif', '$ratarata')";
