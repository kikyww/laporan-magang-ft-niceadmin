...
<div class="card">
            <div class="card-body">
                ...
                $query = "SELECT tb_magang.username AS username, tb_magang.nama AS nama, tb_kegiatan.usn_kegiatan AS usn_kegiatan, COUNT(tanggal) AS tanggal FROM tb_magang LEFT JOIN tb_kegiatan ON tb_magang.username = usn_kegiatan GROUP BY tb_magang.username ORDER BY nama ASC";
                ...
                while ($row = mysqli_fetch_array($data))     
                {
                    ...
                    if ($_SESSION['status'] == 'admin') {
                        echo "<td><div class='btn-row'>
                            ...
                            <a href='./detail_kegiatan.php?username=$row[username]' class='btn btn-warning'><i class='ri ri-contacts-book-2-fill'></i></a>
                            </div>
                            </div>
                            </td>";
                        } else {
